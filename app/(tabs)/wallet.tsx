...
export default function WalletScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Wallet Promo Slot */}
      <CFSlot blockKey="wallet_promo" style={styles.promoSlot}>
      ...
      {/* Upgrade Banner Slot */}
      <CFSlot blockKey="wallet_upgrade" style={styles.upgradeSlot}>
      ...
      {/* Card Offers Slot */}
      <CFSlot blockKey="wallet_card_offers" style={styles.cardOffersSlot}>
      ...
      <CFSlot blockKey="wallet_insights" style={styles.insightsSlot}>
      ...
      {/* Wallet Rewards Slot */}
      <CFSlot blockKey="wallet_rewards" style={styles.rewardsSlot}>
      ...
      {/* Cashback Slot */}
      <CFSlot blockKey="wallet_cashback" style={styles.cashbackSlot}>
      ...
      {/* Goals Slot */}
      <CFSlot blockKey="wallet_goals" style={styles.goalsSlot}>
      ...
      {/* Bottom Banner Slot */}
      <CFSlot blockKey="wallet_bottom" style={styles.bottomSlot}>
