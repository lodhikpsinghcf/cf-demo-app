...
export default function TravelScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Flash Deal Slot */}
      <CFSlot blockKey="travel_flash" style={styles.flashSlot}>
      ...
      {/* Travel Deals Slot */}
      <CFSlot blockKey="travel_hero" style={styles.dealsSlot}>
      ...
      <CFSlot blockKey="travel_spotlight" style={styles.spotlightSlot}>
      ...
      <CFSlot blockKey="travel_promo" style={styles.promoSlot}>
      ...
      <CFSlot blockKey="travel_lastminute" style={styles.lastMinuteSlot}>
      ...
      {/* Hotels Slot */}
      <CFSlot blockKey="travel_hotels" style={styles.hotelsSlot}>
      ...
      {/* Miles Slot */}
      <CFSlot blockKey="travel_miles" style={styles.milesSlot}>
      ...
      {/* Bottom Slot */}
      <CFSlot blockKey="travel_bottom" style={styles.bottomSlot}>
